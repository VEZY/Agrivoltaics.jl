...
DocMeta.setdocmeta!(Agrivoltaics, :DocTestSetup, :(using Agrivoltaics, PlantGeom, CairoMakie); recursive=true)
...
makedocs(;
    modules=[Agrivoltaics],
    authors="Rémi Vezy <VEZY@users.noreply.github.com>",
    repo="https://github.com/VEZY/Agrivoltaics.jl/blob/{commit}{path}#{line}",
    sitename="Agrivoltaics.jl",
    format=Documenter.HTML(; canonical="https://VEZY.github.io/Agrivoltaics.jl"),
    pages=list_pages(),
)

deploydocs(; repo="github.com/VEZY/Agrivoltaics.jl")
